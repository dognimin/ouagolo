...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'examples/images/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN,IMAGES.'logos/');
...
if (!defined('PDF_HEADER_LOGO')) {
    ...
    /*
    if (@file_exists(K_PATH_IMAGES.'logo-ouagolo.jpeg')) {
        $tcpdf_header_logo = 'logo-ouagolo.jpeg';
    }
    */
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by TecHouse - techouse.io");
}
