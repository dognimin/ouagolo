    ...
    if(isset($_SESSION['nouvelle_session'])) {
        ...
        if($utilisateur) {
            ...
            elseif($parametres['type'] == 'ordre') {
                require "../../../Classes/ORDESNATIONNAUX.php";
            ...
            elseif($parametres['type'] == 'qtc') {
                require "../../../Classes/QUALITESCIVILITES.php";
                $QUALIESCIVILITES = new QUALITESCIVILITES();
            ...
            elseif($parametres['type'] == 'act_tit') {
                ...
                $json = $ACTESMEDICAUX->lister_historique_titre($parametres['donnee']);
                ...
                if($nb_patologies != 0) {
                    ...
                    <table class="table table-bordered table-sm table-striped">
                        ...
                        <?php
                        $ligne = 1;
                        foreach ($json as $lettre) {
                            ?>
                            <tr <?php if(!$lettre['date_fin']){echo 'style="font-weight: bold " class="text-success"';} ?>>
                                <td class="align_right"><?= $ligne;?></td>
                                <td><?= $lettre['code'];?></td>
                                <td><?= $lettre['libelle'];?></td>
                                <td class="align_center"><?= date('d/m/Y',strtotime($lettre['date_debut']));?></td>
                                <td class="align_center"><?php if($lettre['date_fin']){echo date('d/m/Y',strtotime($lettre['date_fin']));}?></td>
                                <td><?= $lettre['nom'].' '.$lettre['prenoms'];?></td>
                                <td class="align_center"><?= date('d/m/Y H:i:s',strtotime($lettre['date_creation']));?></td>
                            </tr>
                            <?php
                            $ligne++;
                        }
            ...
            elseif($parametres['type'] == 'act_cha') {
                require "../../../Classes/ACTESMEDICAUX.php";
                $ACTESMEDICAUX = new ACTESMEDICAUX();
                $json = $ACTESMEDICAUX->lister_historique_chapitre($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'act_sec') {
                require "../../../Classes/ACTESMEDICAUX.php";
                $ACTESMEDICAUX = new ACTESMEDICAUX();
                $json = $ACTESMEDICAUX->lister_historique_section($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'act_art') {
                require "../../../Classes/ACTESMEDICAUX.php";
                $ACTESMEDICAUX = new ACTESMEDICAUX();
                $json = $ACTESMEDICAUX->lister_historique_article($parametres['donnee']);
                $nb_actesmedicaux = count($json);
            ...
            elseif($parametres['type'] == 'act_med') {
                require "../../../Classes/ACTESMEDICAUX.php";
                $ACTESMEDICAUX = new ACTESMEDICAUX();
                $json = $ACTESMEDICAUX->lister_historique_acte_medical($parametres['donnee']);
                $nb_actesmedicaux = count($json);
                if($nb_actesmedicaux != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'let_cle') {
                require "../../../Classes/ACTESMEDICAUX.php";
                $ACTESMEDICAUX = new ACTESMEDICAUX();
                $json = $ACTESMEDICAUX->lister_historique_lettre_cle($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'med_lab') {
                ...
                $json = $LABORATOIRES->lister_historique_laboratoires_pharmaceutiques($parametres['donnee']);
                $nb_laboratoires = count($json);
            ...
            elseif($parametres['type'] == 'med_typ') {
                ...
                $json = $TYPESMEDICAMENTS->lister_historique_type_medicament($parametres['donnee']);
            ...
            elseif($parametres['type'] == 'pat_chap') {
                ...
                $json = $PATHOLOGIECHAPITRES->lister_historique_chapitre($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'pat_sch') {
                require "../../../Classes/PATHOLOGIES.php";
                $PATHOLOGIE = new PATHOLOGIES();
                $json = $PATHOLOGIE->lister_historique_sous_chapitre($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'pat') {
                require "../../../Classes/PATHOLOGIES.php";
                $PATHOLOGIE = new PATHOLOGIES();
                $json = $PATHOLOGIE->lister_historique_pathologie($parametres['donnee']);
                $nb_patologies = count($json);
                if($nb_patologies != 0) {
                    ?>
                    <table class="table table-bordered table-sm table-striped">
            ...
            elseif($parametres['type'] == 'res_etab') {
                require "../../../Classes/RESEAUXDESOINS.php";
                $RESEAUXDESOINS = new RESEAUXDESOINS();
                $json = $RESEAUXDESOINS->lister_historique_reseau_etablissements($parametres['donnee1'],$parametres['donnee2']);
