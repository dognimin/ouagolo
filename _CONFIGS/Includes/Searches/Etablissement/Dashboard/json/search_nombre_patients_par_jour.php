            ...
            if ($utilisateur) {
                ...
                if ($profil) {
                    ...
                    if ($user_profil) {
                        ...
                        if ($ets) {
                            $patients = $DASHBOARD->etablissement_nombre_patients_par_jour($ets['code'], $parametres['date_debut'], $parametres['date_fin']);
                            foreach ($patients as $patient) {
                                $date = $patient['annee'].'-'. $patient['mois'].'-'. $patient['jour'];
                                $json[] = array(

                                    'date' => date('d M', strtotime($date)),
                                    'effectif_patients' => $patient['effectif_patients'],
                                    'effectif_factures' => $patient['effectif_factures'],
