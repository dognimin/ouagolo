<p id="p_devise_monetaire_resultats"></p>
<form id="form_devise_monetaire">
    <div class="row">
        <div class="col-sm-3">
            <label for="code_input" class="form-label">Code</label>
            <input type="text" class="form-control form-control-sm" id="code_input" maxlength="6" placeholder="Code" aria-describedby="codeHelp" autocomplete="off">
