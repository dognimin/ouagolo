<p id="p_groupe_sanguin_resultats"></p>
<form id="form_groupe_sanguin">
    <div class="row">
        <div class="col-sm-3">
            <label for="code_input" class="form-label">Code</label>
            <input type="text" class="form-control form-control-sm" id="code_input" maxlength="2" placeholder="Code" aria-describedby="codeHelp" autocomplete="off">
