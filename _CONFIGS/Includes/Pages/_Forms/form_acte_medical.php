...
<form id="form_acte_medical">
    <div class="row">
        <div class="col-sm">
            ...
            <select class="form-select form-select-sm" id="code_titre_input" aria-label=".form-select-sm" aria-describedby="code_titre_input">
                ...
                foreach ($titres as $titre) {
                    echo '<option value="'.$titre['code_titre'].'">'.$titre['libelle'].'</option>';
                }
                ?>
            </select>
        ...
        <div class="col-sm">
            ...
            <select class="form-select form-select-sm" id="code_chapitres_input" aria-label=".form-select-sm" aria-describedby="code_chapitres_input">
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <select class="form-select form-select-sm" id="code_sections_input" aria-label=".form-select-sm" aria-describedby="code_sections_input">
        ...
        <div class="col-sm">
            ...
            <select class="form-select form-select-sm" id="code_article_input" aria-label=".form-select-sm" aria-describedby="code_article_input">
