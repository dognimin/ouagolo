...
<form id="form_lettres_cles">
    <div class="row">
        <div class="col-sm-3">
            ...
            <input type="text" class="form-control form-control-sm" id="code_input" maxlength="5" placeholder="Code" aria-describedby="codeHelp" autocomplete="off">
    ...
    <div class="row">
        <div class="col-sm">
            <label for="libelle_input" class="form-label">Prix</label>
            <input type="text" class="form-control form-control-sm" id="prix_input" maxlength="100" placeholder="prix" aria-describedby="prixHelp" autocomplete="off">
