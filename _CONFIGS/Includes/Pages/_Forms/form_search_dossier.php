<form id="form_search_dossiers">
    <div class="row">
        ...
        <div class="col-sm">
            <label for="num_dossier_search_input" class="form-label">N° Dossier</label>
            <input type="text" class="form-control form-control-sm" id="num_dossier_search_input" maxlength="20" placeholder="Numéro Dossier" aria-describedby="numDossierHelp" autocomplete="off">
            <div id="numDossierHelp" class="form-text"></div>
        </div>
        <div class="col-sm">
            <label for="num_secu_dossier_search_input" class="form-label">N° Sécu</label>
            <input type="text" class="form-control form-control-sm" id="num_secu_dossier_search_input" maxlength="20" placeholder="Numéro Sécu" aria-describedby="numSecuHelp" autocomplete="off">
