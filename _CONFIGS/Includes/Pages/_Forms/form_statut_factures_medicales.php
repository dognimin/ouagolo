<p id="p_statut_factures_medicales_resultats"></p>
<form id="form_statut_factures_medicales">
    <div class="row">
        <div class="col-sm-3">
            <label for="code_input" class="form-label">Code</label>
            <input type="text" class="form-control form-control-sm" id="code_input" maxlength="4" placeholder="Code" aria-describedby="codeHelp" autocomplete="off">
