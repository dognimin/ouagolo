<p id="p_etablissement_service_resultats"></p>
<form id="form_etablissement_service">
    <div class="row">
        <div class="col-sm-3">
            <label for="code_input" class="form-label">Code</label>
            <input type="text" class="form-control form-control-sm" id="code_input" maxlength="10" placeholder="Code" aria-describedby="codeHelp" autocomplete="off">
