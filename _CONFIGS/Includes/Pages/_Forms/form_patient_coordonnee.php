<p id="p_patient_coordonnee_resultats"></p>
<form id="form_patient_coordonnee">
    <div class="row">
        <div class="col-sm-5">
        ...
        <div class="col-sm">
            <label for="valeur_patient_coordonnee_input" class="form-label">Valeur</label>
            <input type="text" class="form-control form-control-sm" id="valeur_patient_coordonnee_input"  maxlength="100" placeholder="Valeur" aria-describedby="valeurHelp" autocomplete="off">
    ...
    <div class="row">
        <div class="col-md-5 d-grid">
            ...
            <button type="submit" id="button_patient_coordonnees_enregistrer" class="btn btn-primary btn-sm btn-block"><i class="bi bi-save"></i> Enregistrer</button>
        </div>
        <div class="col-md-5 d-grid">
