...
<form id="form_article">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <select class="form-select form-select-sm" id="code_chapitre_input" aria-label=".form-select-sm" aria-describedby="code_chapitre_input">
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <select class="form-select form-select-sm" id="code_section_input" aria-label=".form-select-sm" aria-describedby="code_section_input">
