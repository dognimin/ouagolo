<p id="p_sous_chapitre_resultats"></p>
<form id="form_sous_chapitre">
    <div class="row">
        <div class="col-sm">
            <label for="code_chapitre_input" class="form-label">Chapitres</label>
            <select class="form-select form-select-sm" id="code_chapitre_input" aria-label=".form-select-sm" aria-describedby="codeChapitresHelp">
