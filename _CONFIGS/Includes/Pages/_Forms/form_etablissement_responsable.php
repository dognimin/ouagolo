...
<form id="form_responsable">
    <div class="row">
        <div class="col">
            ...
            <?php if ($responsable_etablissement){ ?>
                <input type="hidden" value="<?= $responsable_etablissement['id_user'] ?>" id="responsable_input">
                <input type="text" class="form-control form-control-sm" id="" maxlength="7" placeholder="Code" value="<?=  $responsable_etablissement['nom'].''.$responsable_etablissement['prenoms'] ?>" aria-describedby="codeHelp" autocomplete="off" disabled="true">
            <?php }else{ ?>
