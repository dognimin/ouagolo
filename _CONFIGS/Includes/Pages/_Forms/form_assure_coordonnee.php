<p id="p_assure_coordonnee_resultats"></p>
<form id="form_assure_coordonnee">
    <div class="row">
        <div class="col-sm-5">
        ...
        <div class="col-sm">
            <label for="valeur_assure_coordonnee_input" class="form-label">Valeur</label>
            <input type="text" class="form-control form-control-sm" id="valeur_assure_coordonnee_input"  maxlength="100" placeholder="Valeur" aria-describedby="valeurHelp" autocomplete="off">
    ...
    <div class="row">
        <div class="col-md-5 d-grid">
            ...
            <button type="submit" id="button_assure_coordonnees_enregistrer" class="btn btn-primary btn-sm btn-block"><i class="bi bi-save"></i> Enregistrer</button>
        </div>
        <div class="col-md-5 d-grid">
