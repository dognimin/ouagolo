                                                        ...
                                                        <div class="container-xl" id="div_main_page">
                                                            <nav id="nav_breadcrumb" aria-label="breadcrumb">
                                                                <ol class="breadcrumb">
                                                                    ...
                                                                    <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-file-earmark-medical"></i> Prestations</li>
                                                                </ol>
                                                            </nav>
                                                            <div class="row  justify-content-md-center">
                                                                <div class="col-sm-3">
                                                                    <div class="d-grid div_boxes"><a href="<?= URL . 'organisme/prestations/factures'; ?>" class="btn btn-primary btn-sm"><i class="bi bi-journal-medical"></i><br/> Factures</a></div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="d-grid div_boxes"><a href="<?= URL . 'organisme/prestations/demandes'; ?>" class="btn btn-primary btn-sm"><i class="bi bi-mask"></i><br/> Demandes</a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php
