                ...
                if($user_statut['statut'] == 1) {
                    ...
                    if($user_mdp) {
                        if($user_mdp['statut'] == 1) {
                            include "../../../Menu.php";
                            $reseaux_etablissements= $RESEAUX->lister_reseau_etablissements($_POST['code']);
                            $etablissements= $ETABLISSEMENTS->lister_etablissements();
                            $reseaux_de_soins= $RESEAUX->trouver($_POST['code']);
                            $nb_reseaux_de_soins= count($reseaux_etablissements)
                            ?>
                                            ...
                                            <div class="col-md-10">
                                                <div class="card">
                                                    <div class="card-body row">
                                                        ...
                                                        <div class="row justify-content-md-center">
                                                            <?php include "../../_Forms/form_reseau_de_soin_etablissemnt.php";?>
                                                        </div>
                                        ...
                                        if($nb_reseaux_de_soins == 0) {
                                            ...
                                            <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
                                                ...
                                                foreach ($reseaux_etablissements as $reseau_etablissement) {
                                                    $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($reseau_etablissement['date_debut'])));
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $reseau_etablissement['code_etablissement'];?></td>
                                                        <td class="align_center"><?= date('d/m/Y',strtotime($reseau_etablissement['date_debut']));?></td>
                                                        <td>
                                                            <button type="button" id="<?= $reseau_etablissement['code_reseau'].'|'.$reseau_etablissement['code_etablissement'];?>" class="badge bg-<?php if($validite_edition == 0) {echo 'secondary';}else {echo 'warning';}?> btn_edit" <?php if($validite_edition == 0) {echo 'disabled';} ?>><i class="bi bi-brush"></i></button>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $reseau_etablissement['code_reseau'].'|'. $reseau_etablissement['code_etablissement'];?>|res_etab" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $ligne++;
                            ...
                            echo '<script src="'.JS.'page_parametres_reseaux_de_soins_etablissements.js"></script>';
