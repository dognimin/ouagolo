                ...
                if($user_statut['statut'] == 1) {
                    ...
                    if($user_mdp) {
                        if($user_mdp['statut'] == 1) {
                            include "../../../Menu.php";
                            $reseaux_actes_medicales= $RESEAUX->lister_reseau_actes_medicaux($_POST['code']);
                            $actes= $ACTESMEDICAUX->lister_actes_medicaux(null);
                            $reseaux_de_soins= $RESEAUX->trouver($_POST['code']);
                            $nb_reseaux_de_soins= count($reseaux_actes_medicales)
                            ?>
                            <div class="container-xl" id="div_main_page">
                                <nav id="nav_breadcrumb" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Actes medicaux</li>
                                    </ol>
                                </nav>
                                ...
                                <div class="row  justify-content-md-center">
                                            ...
                                            <div class="col-md-10">
                                                <div class="card">
                                                    <div class="card-body row">
                                                        ...
                                                        <div class="row justify-content-md-center">
                                                            <?php include "../../_Forms/form_reseau_de_soin_acte_medicale.php";?>
                                                        </div>
                                    ...
                                    <div id="div_datas">
                                        ...
                                        if($nb_reseaux_de_soins == 0) {
                                            ?>
                                            <p class="align_center alert alert-warning">Aucun acte medicale  n'a encore été enregistré. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter un nouveau</p>
                                            <?php
                                        }else {
                                            ...
                                            <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
                                                ...
                                                <?php
                                                $ligne = 1;
                                                foreach ($reseaux_actes_medicales as $reseau_acte_medicale) {
                                                    $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($reseau_acte_medicale['date_debut'])));
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $reseau_acte_medicale['code_reseau'];?></td>
                                                        <td><?= $reseau_acte_medicale['code_acte'];?></td>
                                                        <td class="align_center"><?= date('d/m/Y',strtotime($reseau_acte_medicale['date_debut']));?></td>
                                                        <td>
                                                            <button type="button" id="<?= $reseau_acte_medicale['code_reseau'].'|'.$reseau_acte_medicale['code_acte'];?>" class="badge bg-<?php if($validite_edition == 0) {echo 'secondary';}else {echo 'warning';}?> btn_edit" <?php if($validite_edition == 0) {echo 'disabled';} ?>><i class="bi bi-brush"></i></button>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $reseau_acte_medicale['code_reseau'].'|'. $reseau_acte_medicale['code_acte'];?>|res_acte" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $ligne++;
                            ...
                            echo '<script src="'.JS.'page_parametres_reseaux_de_soins_actes_medicaux.js"></script>';
