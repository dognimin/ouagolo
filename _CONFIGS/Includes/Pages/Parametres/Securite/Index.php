                            ...
                            <div class="container-xl" id="div_main_page">
                                <nav id="nav_breadcrumb" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-shield-check"></i> Sécurité</li>
                                    </ol>
                                </nav>
                                <p class="p_page_titre h4"><i class="bi bi-shield-check"></i> Sécurité</p>
                                <div class="row  justify-content-md-center">
                                    <div class="col-sm-3">
                                        <div class="d-grid div_boxes">
                                            <a href="<?= URL.'parametres/securite/compte';?>" class="btn btn-danger btn-sm"><i class="bi bi-shield-check"></i><br /> Sécurité du compte</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="d-grid div_boxes">
                                            <a href="<?= URL.'parametres/securite/mot-de-passe';?>" class="btn btn-danger btn-sm"><i class="bi bi-shield-check"></i><br />Sécurité du mot de passe</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
