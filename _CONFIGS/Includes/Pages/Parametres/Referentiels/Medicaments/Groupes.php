...
?>
<p class="h4">Groupes de médicament</p>
<p class="align_right">
    <button type="button" class="btn btn-primary btn-sm btn_add"><i class="bi bi-plus-square-fill"></i></button>
    <button type="button" id="med_sgroup" class="btn btn-sm btn-secondary"><i class="bi bi-arrow-right-square"></i> Sous-groupes</button>
</p>
<div id="div_form">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../../_Forms/form_medicament_groupe.php";?>
                    </div>
...
<div id="div_datas">
    ...
    if($nb_groupes == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucun groupe n'a encore été enregistré. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter un nouveau</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            foreach ($groupes as $groupe) {
                $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($groupe['date_debut'])));
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $groupe['code'];?>|med_cth" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                    </td>
                </tr>
                <?php
                $ligne++;
    ...
    $("#form_groupe").submit(function () {
        ...
        if(libelle) {
            $("#button_enregistrer").prop('disabled', true)
                ...
                .html('<i>Traitement...</i>');
            $.ajax({
                url: '../../_CONFIGS/Includes/Submits/Parametres/Referentiels/Medicaments/submit_groupe.php',
                type: 'POST',
                data: {
                    'code': code,
                    'libelle': libelle
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_groupe").hide();
                        $("#p_groupe_resultats").removeClass('alert alert-danger')
                        ...
                        $("#p_groupe_resultats").removeClass('alert alert-success')
