                                    ...
                                    if ($profil['code_profil'] == 'ADMN') {
                                        if (isset($parametres['url'])) {
                                            ...
                                            if ($audit['success'] == true) {
                                                ...
                                                $tables = $ACTESMEDICAUX->lister_referentiels();
                                                ?>
                                                    ...
                                                    <nav id="nav_breadcrumb" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item"><a
                                                                    ...
                                                                    Référentiels</a></li>
                                                            <li class="breadcrumb-item active" aria-current="page">Actes
                                                                médicaux
                                                            </li>
                                                        </ol>
                                                    </nav>
                                                    <p class="p_page_titre h4">NGAP</p>
                                                    <div class="row">
                                                        <div class="col-sm-3" id="div_sidebar">
                                                            <?php include "../../_Forms/form_referentiels.php"; ?>
                                                        </div>
                                                        <div class="col-sm" id="div_referentiels_actes_medicaux">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <?php
                                                ...
                                                echo '<script src="' . JS . 'page_parametres_actes_medicaux.js"></script>';
                                            } else {
