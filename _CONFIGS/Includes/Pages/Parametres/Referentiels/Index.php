                                                    ...
                                                    <div class="row  justify-content-md-center">
                                                        <div class="col-sm-3">
                                                            <div class="d-grid div_boxes">
                                                                <a href="<?= URL . 'parametres/referentiels/pathologies'; ?>" class="btn btn-danger btn-sm"><i class="bi bi-file-medical-fill"></i><br/>Pathologies</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="d-grid div_boxes">
                                                                <a href="<?= URL . 'parametres/referentiels/actes-medicaux'; ?>" class="btn btn-danger btn-sm"><i class="bi bi-ui-radios-grid"></i><br/> Actes médicaux</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="d-grid div_boxes">
                                                                <a href="<?= URL . 'parametres/referentiels/medicaments'; ?>" class="btn btn-danger btn-sm"><i class="bi bi-toggles"></i><br/>Medicaments</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="d-grid div_boxes">
                                                                <a href="<?= URL . 'parametres/referentiels/collectivites'; ?>" class="btn btn-danger btn-sm"><i class="bi bi-bookmarks"></i><br/>Collectivités</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
