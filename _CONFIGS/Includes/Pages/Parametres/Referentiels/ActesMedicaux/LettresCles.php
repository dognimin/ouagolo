...
<div id="div_datas">
    ...
    if($nb_lettres_cles == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucune lettre clé n'a encore été enregistrée. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter une nouvelle</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            foreach ($lettres_cles as $lettre_cle) {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" id="<?= $lettre_cle['code'].'|'.$lettre_cle['libelle'].'|'.$lettre_cle['prix_unitaire'];?>" class="badge bg-<?php if($validite_edition == 0) {echo 'secondary';}else {echo 'warning';}?> btn_edit" <?php if($validite_edition == 0) {echo 'disabled';} ?>><i class="bi bi-brush"></i></button>
                    </td>
                    <td>
                        <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $lettre_cle['code'];?>|let_cle" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                    </td>
                </tr>
                <?php
                $ligne++;
