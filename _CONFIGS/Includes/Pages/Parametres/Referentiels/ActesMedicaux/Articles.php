...
$actesmedicaux = $ACTESMEDICAUX->lister_articles(null);
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            foreach ($actesmedicaux as $actemedical) {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" id="<?= $actemedical['code'].'|'.$actemedical['libelle'].'|'.$actemedical['titre_code'].'|'.$actemedical['chapitre_code'].'|'.$actemedical['code_section'];?>" class="badge bg-<?php if($validite_edition == 0) {echo 'secondary';}else {echo 'warning';}?> btn_edit" <?php if($validite_edition == 0) {echo 'disabled';} ?>><i class="bi bi-brush"></i></button>
                    </td>
                    <td>
                        <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $actemedical['code'];?>|act_art" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                    </td>
                </tr>
                <?php
                $ligne++;
