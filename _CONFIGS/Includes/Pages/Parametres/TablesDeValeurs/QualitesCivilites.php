...
require_once "../../../../Classes/QUALITESCIVILITES.php";
$QUALITECIVILITE = new QUALITESCIVILITES();
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../_Forms/form_qualite_civilite.php";?>
                    </div>
...
<div id="div_datas">
    <?php
    if($nb_qualitecivilite == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucune qualité civile n'a encore été enregistrée. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter une nouvelle</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            <?php
            $ligne = 1;
            foreach ($qualitecivilites as $qualitecivilite) {
                $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($qualitecivilite['date_debut'])));
...
<script>
    ...
    $(".btn_add").click(function () {
        $("#div_datas").hide();
        $("#div_form").slideDown();
        $(".card-title").html('Nouvelle qualité civile');
        return false;
    });
    ...
    $("#form_qualite_civilite").submit(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_qualite_civilite").hide();
                        $("#p_qualite_civilite_resultats").removeClass('alert alert-danger')
                            .addClass('alert alert-success')
                            .html(data['message']);
                        setTimeout(function () {
                            display_tables_de_valeurs('qtc');
                        },5000);
                    }else {
                        $("#p_qualite_civilite_resultats").removeClass('alert alert-success')
    ...
    $(".btn_edit").click(function () {
        ...
        $(".card-title").html('Edition de qualité civile');
    ...
    $("#export_input").change(function () {
        ...
        if(code_export) {
            window.open("exporter-table-de-valeurs.php?type="+code_export+"&data=qtc", "PopupWindow", "width=600,height=600,scrollbars=yes,resizable=no");
        }
    });
</script>
