...
?>
<p class="h4">Catégories socio-professionnelles</p>
<p class="align_right">
        ...
        <table class="table table-bordered table-hover table-sm" id="tableDeValeurs">
            ...
            foreach ($professions as $profession) {
                ...
                <tr>
                    ...
                    <td><?= date('d/m/Y',strtotime($profession['date_debut']));?></td>
                    <td>
    ...
    $("#form_profession").submit(function () {
        ...
        if(code && libelle) {
            $("#button_enregistrer").prop('disabled', true)
                ...
                .html('<i>Traitement...</i>');
            $.ajax({
                url: '../_CONFIGS/Includes/Submits/Parametres/submit_profession.php',
                type: 'POST',
                data: {
                    'code': code,
                    'libelle': libelle
