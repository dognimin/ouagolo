        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../_Forms/form_departement.php";?>
                    </div>
...
<div id="div_datas">
    ...
    if($nb_departement == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucune departement n'a encore été enregistrée. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter une nouvelle</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm" id="tableDeValeurs">
            ...
            foreach ($departements as $departement) {
                $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($departement['date_debut'])));
...
<script>
    ...
    $("#form_departement").submit(function () {
        ...
        if(code_pays && code_region && code && nom) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_departement").hide();
                        $("#p_departement_resultats").removeClass('alert alert-danger')
                        ...
                        $("#p_departement_resultats").removeClass('alert alert-success')
            ...
            if(!code_region) {
                ...
                $("#codeRegionHelp")
                    .addClass('text-danger')
                    .html("Veuillez sélectionner la region SVP.");
            }
            if(!code) {
    ...
    $("#export_input").change(function () {
        ...
        if(code_export) {
            window.open("exporter-table-de-valeurs.php?type="+code_export+"&data=dep", "PopupWindow", "width=600,height=600,scrollbars=yes,resizable=no");
        }
    });
</script>
