        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../_Forms/form_categorie_socio_professionnelle.php";?>
                    </div>
...
<div id="div_datas">
    ...
    if($nb_categories == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucune catégorie n'a encore été enregistrée. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter une nouvelle</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            foreach ($categories as $categorie) {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="badge bg-dark button_historique" data-bs-toggle="modal" id="<?= $categorie['code'];?>|csp" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i></button>
                    </td>
                </tr>
                <?php
                $ligne++;
...
<script>
    ...
    $(".btn_add").click(function () {
        $("#div_datas").hide();
        $("#div_form").slideDown();
        $(".card-title").html('Nouvelle catégorie');
        return false;
    });
    ...
    $("#form_categorie_socio_professionnelle").submit(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_categorie_socio_professionnelle").hide();
                        $("#p_categorie_socio_professionnelle_resultats").removeClass('alert alert-danger')
                            .addClass('alert alert-success')
                            .html(data['message']);
                        setTimeout(function () {
                            display_tables_de_valeurs('csp');
                        },5000);
                    }else {
                        $("#p_categorie_socio_professionnelle_resultats").removeClass('alert alert-success')
    ...
    $(".btn_edit").click(function () {
        ...
        $(".card-title").html('Edition de catégorie');
    });
    ...
    $("#export_input").change(function () {
        ...
        if(code_export) {
            window.open("exporter-table-de-valeurs.php?type="+code_export+"&data=csp", "PopupWindow", "width=600,height=600,scrollbars=yes,resizable=no");
        }
    });
</script>
