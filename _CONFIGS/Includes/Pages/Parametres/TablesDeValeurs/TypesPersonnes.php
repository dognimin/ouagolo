...
<script>
    ...
    $(".btn_add").click(function () {
        $("#div_datas").hide();
        $("#div_form").slideDown();
        $(".card-title").html('Nouveau type personne');
        return false;
    });
    ...
    $("#form_type_ecu").submit(function () {
        ...
        if(code && libelle) {
            $("#button_enregistrer").prop('disabled', true)
                ...
                .html('<i>Traitement...</i>');
            $.ajax({
                url: '../_CONFIGS/Includes/Submits/Parametres/TablesDeValeurs/submit_type_personne.php',
                type: 'POST',
                data: {
                    'code': code,
                    'libelle': libelle
    ...
    $(".btn_edit").click(function () {
        ...
        $(".card-title").html('Edition de type personne ');
