...
$groupes = $GROUPESSANGUINS->lister();
$nb_groupes = count($groupes);
?>
<p class="h4">Groupes sanguins</p>
<p class="align_right">
    <button type="button" class="btn btn-primary btn-sm btn_add"><i class="bi bi-plus-square-fill"></i></button>
    <button type="button" id="rhs" class="btn btn-sm btn-secondary"><i class="bi bi-arrow-right-square"></i> Rhesus</button>
</p>
<div id="div_form">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../_Forms/form_groupe_sanguin.php";?>
                    </div>
...
<script>
    ...
    $(".btn_add").click(function () {
        $("#div_datas").hide();
        $("#div_form").slideDown();
        $(".card-title").html('Nouveau groupe sanguin');
        return false;
    });
    ...
    $("#form_groupe_sanguin").submit(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_groupe_sanguin").hide();
                        $("#p_groupe_sanguin_resultats").removeClass('alert alert-danger')
                            .addClass('alert alert-success')
                            .html(data['message']);
                        setTimeout(function () {
                            display_tables_de_valeurs('gsa');
                        },5000);
                    }else {
                        $("#p_groupe_sanguin_resultats").removeClass('alert alert-success')
    ...
    $(".btn_edit").click(function () {
        ...
        $(".card-title").html('Edition de groupe sanguin');
    ...
    $("#export_input").change(function () {
        ...
        if(code_export) {
            window.open("exporter-table-de-valeurs.php?type="+code_export+"&data=gsa", "PopupWindow", "width=600,height=600,scrollbars=yes,resizable=no");
        }
    });
</script>
