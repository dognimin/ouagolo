...
$nb_rhesus = count($rhesuss);
?>
<p class="h4">Rhesus</p>
<p class="align_right">
    <button type="button" class="btn btn-primary btn-sm btn_add"><i class="bi bi-plus-square-fill"></i></button>
    <button type="button" id="gsa" class="btn btn-sm btn-secondary"><i class="bi bi-arrow-right-square"></i> Groupes sanguins</button>
</p>
<div id="div_form">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="row justify-content-md-center">
                        <?php include "../../_Forms/form_rhesus.php";?>
                    </div>
...
<div id="div_datas">
    ...
    if($nb_rhesus == 0) {
        ?>
        <p class="align_center alert alert-warning">Aucun rhesus n'a encore été enregistré. <br />Cliquez sur <a href="" class="btn_add"><i class="bi bi-plus-square-fill"></i></a> pour ajouter un nouveau</p>
        <?php
    }else {
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="tableDeValeurs">
            ...
            foreach ($rhesuss as $rhesus) {
                $date_edition = date('Y-m-d',strtotime('+1 day',strtotime($rhesus['date_debut'])));
...
<script>
    ...
    $(".btn_add").click(function () {
        $("#div_datas").hide();
        $("#div_form").slideDown();
        $(".card-title").html('Nouveau rhesus');
        return false;
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        $("#form_rhesus").hide();
                        $("#p_rhesus_resultats").removeClass('alert alert-danger')
                        ...
                        $("#p_rhesus_resultats").removeClass('alert alert-success')
    ...
    $(".btn_edit").click(function () {
        ...
        $(".card-title").html('Edition de rhesus');
    ...
    $("#export_input").change(function () {
        ...
        if(code_export) {
            window.open("exporter-table-de-valeurs.php?type="+code_export+"&data=rhs", "PopupWindow", "width=600,height=600,scrollbars=yes,resizable=no");
        }
    });
</script>
