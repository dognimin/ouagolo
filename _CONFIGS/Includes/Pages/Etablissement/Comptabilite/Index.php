                                                    ...
                                                    if (in_array('AFF_CPTS', $modules, true)) {
                                                        if (isset($parametres['url'])) {
                                                            ...
                                                            if ($audit['success'] === true) {
                                                                ...
                                                                <div class="container-xl" id="div_main_page">
                                                                    <nav id="nav_breadcrumb" aria-label="breadcrumb">
                                                                        <ol class="breadcrumb">
                                                                            ...
                                                                            <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-cash-coin"></i> Comptabilité</li>
                                                                        </ol>
                                                                    </nav>
                                                                    <p class="p_page_titre h4"><i class="bi bi-cash-coin"></i> Comptabilité</p>
                                                                    <div class="row  justify-content-md-center">
                                                                        <div class="row  justify-content-md-center">
                                                                            <div class="col-sm-12"><?php include "../../_Forms/form_search_ets_ecritures_comptables.php"; ?></div>
                                                                        </div>
                                                                    </div>
                                                                    <script>
                                                                ...
                                                                echo '<script src="'.JS.'page_etablissement_comptabilite.js"></script>';
                                                            } else {
