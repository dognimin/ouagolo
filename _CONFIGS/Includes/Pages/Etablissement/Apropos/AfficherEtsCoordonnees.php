        ...
        if ($user) {
            ...
            if ($ets) {
                ...
                if ($nb_modules !== 0) {
                    ...
                    if (in_array('AFF_APRP', $sous_modules, true)) {
                                        ...
                                        foreach ($coordonnees as $coordonnee) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (in_array($coordonnee['code_type'], $tableau_tel, true)) {
                                                        $donnee_c = chunk_split($coordonnee['valeur'], 2, ' ');
                                                    } elseif (in_array($coordonnee['code_type'], $tableau_mail, true)) {
                                                        $donnee_c = '<a href="mailto:' . $coordonnee['valeur'] . '">' . $coordonnee['valeur'] . '</a>';
                                                    } elseif (in_array($coordonnee['code_type'], $tableau_site, true)) {
                                                ...
                                                if (in_array('EDT_APRP', $sous_modules, true)) {
                                                    ?>
                                                    <td><button type="button" class="badge bg-danger"><i class="bi bi-trash-fill"></i></button></td>
                                                    <td><button type="button" id="<?= $coordonnee['code_type'] . '|' . $coordonnee['libelle']; ?>" class="badge bg-<?= $validite_edition === 0? 'secondary': 'warning';?> btn_edit" <?= $validite_edition === 0? 'disabled': null;?>><i class="bi bi-brush"></i></button></td>
                                                    <?php
                                                }
                                                ?>
                                            </tr>
                ...
                success: function (data) {
                    ...
                    if (data['success'] === true) {
                        ...
                        $("#p_etablissement_coordonnee_resultats").removeClass('alert alert-danger')
                            ...
                            .html(data['message']);
                        setTimeout(function () {
                            display_ets_coordonnees(2, code_ets);
                        },5000);
                    }else {
