    ...
    if(isset($_SESSION['nouvelle_session'])) {
        ...
        if ($session) {
            ...
            if($utilisateur) {
                ...
                $edition = $FORMES->editer_forme(strtoupper(conversion_caracteres_speciaux($parametres['code'])), strtoupper(conversion_caracteres_speciaux($parametres['libelle'])),$utilisateur['id_user']);
