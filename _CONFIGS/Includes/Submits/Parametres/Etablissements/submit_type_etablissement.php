...
if(isset($_POST)) {
    ...
    if(isset($_SESSION['nouvelle_session'])) {
        ...
        if($utilisateur) {
            ...
            $edition = $ETABLISSEMENTS->editer_type_etablissement($parametres['code_etablissement'],strtoupper(conversion_caracteres_speciaux($parametres['type'])),$utilisateur['id_user']);
