...
if(isset($_POST)) {
    ...
    if(isset($_SESSION['nouvelle_session'])) {
        ...
        if($utilisateur) {
            ...
            $edition = $ETABLISSEMENTS->editer_ets_service(strtoupper(conversion_caracteres_speciaux($parametres['code_ets'])),strtoupper(conversion_caracteres_speciaux($parametres['code_service'])),$utilisateur['id_user']);
