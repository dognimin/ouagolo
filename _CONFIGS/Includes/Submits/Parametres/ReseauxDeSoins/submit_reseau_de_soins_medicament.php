...
if(isset($_POST)) {
    ...
    if(isset($_SESSION['nouvelle_session'])) {
        ...
        if($utilisateur) {
            ...
            $edition = $RESEAUXDESOINS->editer_reseau_medicament($parametres['code_reseau'],$parametres['medicament_code'],conversion_caracteres_speciaux($parametres['tarif']),$utilisateur['id_user']);
