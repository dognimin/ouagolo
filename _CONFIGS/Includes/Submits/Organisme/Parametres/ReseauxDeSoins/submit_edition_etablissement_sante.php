...
if (isset($_POST)) {
    ...
    $parametres = array(
        ...
        'code_reseau' => clean_data($_POST['code_reseau']),
        'date_debut' => clean_data($_POST['date_debut'])
    );
            ...
            if ($user) {
                ...
                if($user_profil) {
                    ...
                    if($organisme) {
                        ...
                        $edition = $RESEAUXDESOINS->editer_reseau_etablissement($parametres['code_reseau'], $parametres['code'], $user['id_user']);
                        if ($edition['success'] == true) {
                            $audit = $UTILISATEURS->editer_piste_audit($session['code_session'], ACTIVE_URL, 'EDITION RESEAU DE SOINS ETABLISSEMENT', json_encode($parametres));
