...
if (isset($_POST)) {
    ...
    $parametres = array(
        ...
        'code_medicament' => clean_data($_POST['code_medicament']),
        'tarif_medicament' => clean_data($_POST['tarif_medicament']),
            ...
            if ($user) {
                ...
                if($user_profil) {
                    ...
                    if($organisme) {
                        ...
                        $edition = $PANIERSDESOINS->editer_panier_medicament($parametres['code_panier'], $parametres['code_medicament'], $parametres['tarif_medicament'], $parametres['date_debut'], $user['id_user']);
                        if ($edition['success'] == true) {
                            $audit = $UTILISATEURS->editer_piste_audit($session['code_session'], ACTIVE_URL, 'EDITION ORGANISME PANIER DE SOINS MEDICAMENT', json_encode($parametres));
