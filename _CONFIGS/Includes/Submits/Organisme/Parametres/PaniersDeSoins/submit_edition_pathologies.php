...
if (isset($_POST)) {
    ...
    $parametres = array(
        ...
        'code_pathologie' => clean_data($_POST['code_pathologie']),
            ...
            if ($user) {
                ...
                if($user_profil) {
                    ...
                    if($organisme) {
                        ...
                        $edition = $PANIERSDESOINS->editer_panier_pathologie($parametres['code_panier'], $parametres['code_pathologie'], $parametres['date_debut'], $user['id_user']);
                        if ($edition['success'] == true) {
                            $audit = $UTILISATEURS->editer_piste_audit($session['code_session'], ACTIVE_URL, 'EDITION ORGANISME PANIER DE SOINS PATHOLOGIES', json_encode($parametres));
