                    ...
                    if ($user_profil) {
                        ...
                        if ($ets) {
                            ...
                            if ($nb_modules !== 0) {
                                ...
                                if (in_array('AFF_DOSS', $modules, true) && in_array('EDT_DOS_PATHG', $sous_modules, true)) {
                                    $edition = $DOSSIERS->ajouter_pathologie($parametres['code_dossier'], $parametres['code'], $user['id_user']);
                                    if ($edition['success'] == true) {
                                        $audit = $UTILISATEURS->editer_piste_audit($session['code_session'], ACTIVE_URL, 'EDITION PATHOLOGIE PATIENT', json_encode($parametres));
