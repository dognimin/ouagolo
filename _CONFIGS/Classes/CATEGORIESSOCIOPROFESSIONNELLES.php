...
class CATEGORIESSOCIOPROFESSIONNELLES extends  BDD
{
    private function ajouter($code, $libelle, $user){
        $a = $this->bdd->prepare("INSERT INTO tb_ref_categories_socio_professionnelles(categorie_socio_professionnelle_code, categorie_socio_professionnelle_libelle, categorie_socio_professionnelle_date_debut, utilisateur_id_creation)
    ...
    private function fermer($code, $date_fin, $user) {
        $a = $this->bdd->prepare("UPDATE tb_ref_categories_socio_professionnelles  SET categorie_socio_professionnelle_date_fin = ?, date_edition = ?, utilisateur_id_edition = ? WHERE categorie_socio_professionnelle_code = ? AND categorie_socio_professionnelle_date_fin IS NULL");
