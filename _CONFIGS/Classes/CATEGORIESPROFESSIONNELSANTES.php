...
class CATEGORIESPROFESSIONNELSANTES extends BDD
{
    ...
    private function ajouter($code, $libelle, $user){
        $a = $this->bdd->prepare("INSERT INTO tb_ref_categories_professionnelles_sante(categorie_professionnelle_sante_code,categorie_professionnelle_sante_libelle,categorie_professionnelle_sante_date_debut, utilisateur_id_creation)
    ...
    private function fermer($code, $date_fin, $user) {
        $a = $this->bdd->prepare("UPDATE tb_ref_categories_professionnelles_sante  SET categorie_professionnelle_sante_date_fin = ?, date_edition = ?,  	utilisation_id_edition = ? WHERE categorie_professionnelle_sante_code = ? AND categorie_professionnelle_sante_date_fin IS NULL");
