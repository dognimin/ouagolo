...
class QUALITESCIVILITES extends  BDD
{
    private function ajouter($code, $libelle, $user){
        $a = $this->bdd->prepare("INSERT INTO tb_ref_qualites_civiles(qualite_civile_code, qualite_civile_libelle, qualite_civile_date_debut, utilisateur_id_creation)
