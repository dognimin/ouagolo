...
class ETABLISSEMENTSSERVICES extends BDD
{
    ...
    private function ajouter($code, $libelle, $user){
        $a = $this->bdd->prepare("INSERT INTO tb_ref_etablissements_services(etablissement_service_code,etablissement_service_libelle, etablissement_service_date_debut, utilisateur_id_creation)
