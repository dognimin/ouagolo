...
if($type == 'csv') {
    ...
    elseif($data == 'csp') {
        ...
        if($nb_categories != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_CATEGORIES_SOCIO_PROFESSIONNELLES_'.date('dmYhis',time()).'.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'cps') {
        ...
        if($nb_categories != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_CATEGORIES_PROFESSIONNELS_SANTE_'.date('dmYhis',time()).'.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'ordre') {
        require "../_CONFIGS/Classes/ORDESNATIONNAUX.php";
        $ORDESNATIONNAUX = new ORDESNATIONNAUX();
        $ordres = $ORDESNATIONNAUX->lister();
        $nb_ordres = count($ordres);
        if($nb_ordres != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_ORDRES_NATIONNAUX_'.date('dmYhis',time()).'.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'civ') {
        ...
        if($nb_civilites != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_CIVILITES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'sex') {
        ...
        if($nb_sexes != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_SEXES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'typ_pers') {
        ...
        $TYPES_PERSONNES_ECU = new TYPESPERSONNESECU();
        $types_personnes = $TYPES_PERSONNES_ECU->lister();
        $nb_types_personnes_ecu = count($types_personnes);
        if($nb_types_personnes_ecu != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_TYPES_PERSONNES_ECU_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'tac') {
        ...
        if($nb_typesaccidents != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TYPES_ACCIDENTS' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'sif') {
        ...
        if($nb_situationfamilles != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_SITUATIONS_FAMILIALES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'sct') {
        ...
        if($nb_secteursactivites != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_SECTEURS_ACTIVITES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'prf') {
        ...
        if($nb_professions != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_PROFESSIONS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'qtc') {
        require "../_CONFIGS/Classes/QUALITESCIVILITES.php";
        $QUALITESCIVILTES = new QUALITESCIVILITES();
            $qualitesciviles = $QUALITESCIVILTES->lister();
        $nb_qualitesciviles = count($qualitesciviles);
        if($nb_qualitesciviles != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_QUALITES_CIVILES' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'tco') {
        ...
        if($nb_typescoordonnees != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEYRS_TYPES_COORDONNEES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'tpi') {
        ...
        if($nb_typespiecesidentites != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_TYPES_COORDONNEES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'dev') {
        ...
        if($nb_devises != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_DEVISES_MONETAIRES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'gsa') {
        ...
        if($nb_groupesanguins != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_GROUPES_SANGUINS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'rhs') {
        ...
        if($nb_groupesanguins != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_RHESUS_SANGUINS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'lge') {
        ...
        $pays = $PAYS->lister_pays();
        $nb_pays = count($pays);
        if($nb_pays != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_PAYS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'reg') {
        ...
        $regions = $REGIONS->lister_region(null);
        $nb_regions = count($regions);
        if($nb_regions != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_REGIONS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'dep') {
        ...
        $departemements = $DEPARTEMENTS->lister_departement(null);
        $nb_departemements = count($departemements);
        if($nb_departemements != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_DEPARTEMENTS_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
    ...
    elseif($data == 'com') {
        ...
        $communes = $COMMUNES->lister_communes(null);
        $nb_communes = count($communes);
        if($nb_communes != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TABLE_VALEURS_COMMUNES_' . date('dmYhis', time()) . '.csv"');
            //$donnees = array('CODE', 'LIBELLE', 'DATE EFFET');
...
elseif($type == 'xls') {
    ...
    elseif ($data == 'ordre') {
        $file_name = "EXPORT_TABLE_VALEURS_ORDRES_NATIONNAUX_".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
        ...
        if($nb_ordres != 0) {
            ...
            $row = 1;
            $sheet->getStyle('D'.$row.':L'.$row)->applyFromArray($style_titre);
            $sheet->setCellValue('D'.$row, 'TABLE DE VALEURS: ORDRES NATIONNAUX');
            $sheet->mergeCells('D'.$row.':L'.($row = $row+2));
            $sheet->getStyle('D1'.':L'.$row)
                ->getBorders()
                ->getAllBorders()
    ...
    elseif ($data == 'typ_pers') {
        $file_name = "EXPORT_TABLE_VALEURS_TYPES_PERSONNES_ECU".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
    ...
    elseif ($data == 'tco') {
        ...
        require "../_CONFIGS/Classes/TYPESCOORDONNEES.php";
        $TYPESCOORDONNEES = new QUALITESCIVILITES();
        $typescoordonnees = $TYPESCOORDONNEES->lister();
        $nb_typescoordonnees = count($typescoordonnees);
        if($nb_typescoordonnees != 0) {
    ...
    elseif ($data == 'gsa') {
        $file_name = "EXPORT_TABLE_VALEURS_GROUPES_SANGUINS".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
    ...
    elseif ($data == 'rhs') {
        $file_name = "EXPORT_TABLE_VALEURS_RHESUS_SANGUINS".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
    ...
    elseif ($data == 'lge') {
        $file_name = "EXPORT_TABLE_VALEURS_PAYS".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
    ...
    elseif ($data == 'reg') {
        $file_name = "EXPORT_TABLE_VALEURS_REGION".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');
    ...
    elseif ($data == 'dep') {
        $file_name = "EXPORT_TABLE_VALEURS_DEPARTEMENT".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');

        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $REGIONS = new LOCALISATIONSGEOGRAPHIQUES();
        $regions = $REGIONS->lister_departement(null);
        $nb_regions = count($regions);
        if($nb_regions != 0) {
            $row = 1;
            $sheet->getStyle('D'.$row.':O'.$row)->applyFromArray($style_titre);
    ...
    elseif ($data == 'com') {
        $file_name = "EXPORT_TABLE_VALEURS_COMMUNES".date('dmYhis',time()).".xls";
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment; filename="'.$file_name.'"');

        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $REGIONS = new LOCALISATIONSGEOGRAPHIQUES();
        $regions = $REGIONS->lister_commune(null);
        $nb_regions = count($regions);
        if($nb_regions != 0) {
            $row = 1;
...
elseif ($type == 'pdf') {
    ...
    if ($data == 'put') {
        ...
        if($nb_profils != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />PROFILS UTILISATEURS</h1>', 0, 1, 0, true, 'C', true);
    ...
    elseif ($data == 'csp') {
        ...
        if($nb_categories != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />CATEGORIES SOCIO-PROFESSIONNELLES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'cps') {
        ...
        if($nb_categories != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />CATEGORIES PROFESSIONNELS DE SANTE</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'ordre') {
            $file_name = "EXPORT_TABLE_VALEURS_ORDRES_NATIONNAUX_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        ...
        if($nb_ordres != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />ORDRES NATIONNAUX</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'civ') {
            $file_name = "EXPORT_TABLE_VALEUR_CIVILITES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/CIVILITES.php";
        $CIVILITES = new CIVILITES();
        $civilites = $CIVILITES->lister();
        ...
        if($nb_civilites != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />CIVILITES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'sex') {
            $file_name = "EXPORT_TABLE_VALEUR_SEXES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/SEXES.php";
        $SEXES = new SEXES();
        $sexes = $SEXES->lister();
        ...
        if($nb_sexes != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />SEXES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'typ_pers') {
            $file_name = "EXPORT_TABLE_VALEUR_TYPES_PERSONNES_ECU_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/TYPESPERSONNES.php";
        $TYPES_PERSONNES_ECU = new TYPESPERSONNESECU();
        $types_personnes = $TYPES_PERSONNES_ECU->lister();
        ...
        if($nb_types_personnes_ecu != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />TYPES PERSONNES ECU</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == '$types_personne') {
            $file_name = "EXPORT_TABLE_VALEUR_TYPES_PERSONNES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/TYPESPERSONNES.php";
        $TYPES_PERSONNES_ECU = new TYPESPERSONNESECU();
        $types_personnes = $TYPES_PERSONNES_ECU->lister();
        ...
        if($nb_types_personnes_ecu != 0) {
            ...
            foreach ($types_personnes as $types_personne) {
                $pdf->SetFont('helvetica', 'B', 8, '', true);
                $pdf->MultiCell(10, 5, $ligne, 1, 'R', 1, 0, '', '', true);
                $pdf->MultiCell(100, 5, $types_personne['code'], 1, 'L', 1, 0, '', '', true);
                $pdf->MultiCell(150, 5, $types_personne['libelle'], 1, 'L', 1, 0, '', '', true);
                $pdf->MultiCell(20, 5, date('d/m/Y',strtotime($types_personne['date_debut'])), 1, 'C', 1, 1, '', '', true);
                $ligne++;
            }
    ...
    elseif ($data == 'tac') {
            $file_name = "EXPORT_TABLE_VALEUR_TYPES_ACCIDENTS_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/TYPESACCIDENTS.php";
        $TYPESACCIDENTS = new TYPESACCIDENTS();
        $typesaccidents = $TYPESACCIDENTS->lister();
        ...
        if($nb_typesaccidents != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />TYPES ACCIDENTS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'sif') {
            $file_name = "EXPORT_TABLE_VALEUR_SITUATIONS_FAMILIALES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/SITUATIONSFAMILIALES.php";
        $SITUATIONFAMILLES = new SITUATIONSFAMILIALES();
        $situationfamilles = $SITUATIONFAMILLES->lister();
        ...
        if($nb_situationfamilles != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />SITUATIONS FAMILIALES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'sct') {
            $file_name = "EXPORT_TABLE_VALEUR_SECTEURS_ACTIVITES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/SECTEURSACTIVITES.php";
        $SECTEURSACTVITES = new SECTEURSACTIVITES();
        $secteursactivites = $SECTEURSACTVITES->lister();
        ...
        if($nb_secteursactivites != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />SECTEURS ACTIVITES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'prf') {
            $file_name = "EXPORT_TABLE_VALEUR_PROFESSIONS_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/PROFESSIONS.php";
        $PROFESSIONS = new PROFESSIONS();
        $professions = $PROFESSIONS->lister();
        ...
        if($nb_professions != 0) {
            ...
            $pdf->Image(IMAGES.'logos/logo-ouagolo.png', 9, 10, 50, 30, 'PNG', 'https://techouse.io', 'L', true, 150, '', false, false, 0, false, false, false);
            ;
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />PROFESSIONS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
            ...
            foreach ($professions as $profession) {
                $pdf->SetFont('helvetica', 'B', 8, '', true);
                $pdf->MultiCell(10, 5, $ligne, 1, 'R', 1, 0, '', '', true);
                $pdf->MultiCell(100, 5, $profession['code'], 1, 'L', 1, 0, '', '', true);
                $pdf->MultiCell(150, 5, $profession['libelle'], 1, 'L', 1, 0, '', '', true);
    ...
    elseif ($data == 'qtc') {
            $file_name = "EXPORT_TABLE_VALEUR_QUELITES_CIVILES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/QUALITESCIVILITES.php";
            $QUALITESCIVILTES = new QUALITESCIVILITES();
        $qualitesciviles = $QUALITESCIVILTES->lister();
        ...
        if($nb_qualitesciviles != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />QUALITES CIVILITES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'tco') {
            $file_name = "EXPORT_TABLE_VALEUR_TYPES_COORDONNEES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/TYPESCOORDONNEES.php";
        $TYPESCOORDONNEES = new TYPESCOORDONNEES();
        $typescoordonnees = $TYPESCOORDONNEES->lister();
        ...
        if($nb_typescoordonnees != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />TYPES COORDONNEES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'tpi') {
            $file_name = "EXPORT_TABLE_VALEUR_TYPES_PIECES_IDENTITES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/TYPESPIECESIDENTITES.php";
        $TYPESPIECESIDENTITES = new TYPESPIECESIDENTITES();
        $typespiecesidentites = $TYPESPIECESIDENTITES->lister();
        ...
        if($nb_typespiecesidentites != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />TYPES PIECES IDENTITES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'dev') {
        $file_name = "EXPORT_TABLE_VALEUR_DEVISES_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/DEVISESMONETAIRES.php";
        $DEVISES = new DEVISESMONETAIRES();
        $devises = $DEVISES->lister();
        ...
        if($nb_devises != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />DEVISES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'gsa') {
            $file_name = "EXPORT_TABLE_VALEUR_GROUPES_SANGUINS_".date('dmYhis',time()).".csv";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/GROUPESSANGUINS.php";
        $GROUPESSANGUINS = new GROUPESSANGUINS();
        $groupesanguins = $GROUPESSANGUINS->lister();
        ...
        if($nb_groupesanguins != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />GROUPES SANGUINS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'rhs') {
            $file_name = "EXPORT_TABLE_VALEUR_RHESUS_SANGUINS_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/GROUPESSANGUINS.php";
        $RHESUS = new GROUPESSANGUINS();
        ...
        if($nb_rhesus != 0) {
            ...
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />RHESUS SANGUINS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'lge') {
        $pdf->AddPage('L');
        $pdf->Image(IMAGES.'logos/logo-ouagolo.png', 9, 10, 50, 30, 'PNG', 'https://techouse.io', 'L', true, 150, '', false, false, 0, false, false, false);
            $file_name = "EXPORT_TABLE_VALEUR_PAYS_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $PAYS = new LOCALISATIONSGEOGRAPHIQUES();
        $pays = $PAYS->lister_pays();
        $nb_pays = count($pays);
        if($nb_pays != 0) {
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />PAYS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'reg') {
        $pdf->AddPage('L');
        $pdf->Image(IMAGES.'logos/logo-ouagolo.png', 9, 10, 50, 30, 'PNG', 'https://techouse.io', 'L', true, 150, '', false, false, 0, false, false, false);
            $file_name = "EXPORT_TABLE_VALEUR_REGIONS_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $REGIONS = new LOCALISATIONSGEOGRAPHIQUES();
        $regions = $REGIONS->lister_region(null);
        $nb_regions = count($regions);
        if($nb_regions != 0) {
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />REGIONS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'dep') {
        ...
        $file_name = "EXPORT_TABLE_VALEUR_DEPARTEMENTS_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $DEPARTEMENTS = new LOCALISATIONSGEOGRAPHIQUES();
        $departemements = $DEPARTEMENTS->lister_departement(null);
        $nb_departemements = count($departemements);
        if($nb_departemements != 0) {
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />DEPARTEMENTS</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
    ...
    elseif ($data == 'com') {
        ...
        $file_name = "EXPORT_TABLE_VALEUR_COMMUNES_".date('dmYhis',time()).".pdf";
        $pdf->SetTitle($file_name);
        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $COMMUNES = new LOCALISATIONSGEOGRAPHIQUES();
        $communes = $COMMUNES->lister_communes(null);
        $nb_communes = count($communes);
        if($nb_communes != 0) {
            $pdf->writeHTMLCell(0, 0, 50, 15, '<h1>TABLE DE VALEUR:<br />COMMUNES</h1>', 0, 1, 0, true, 'C', true);
            $pdf->setCellPaddings(1, 1, 1, 1);
            $pdf->MultiCell(10, 15, NULL, 0, 'L', 1, 1, '', '', true);
...
elseif($type == 'txt') {
    ...
    elseif($data == 'cps') {
        ...
        if($nb_categories != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_CATEGORIES_PROFESSIONNELS_SANTE_'.date('dmYhis',time()).'.txt"');
    ...
    elseif($data == 'cps') {
        ...
        if($nb_ordres != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_ORDRES_NATIONNAUX_'.date('dmYhis',time()).'.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE",3,' ',STR_PAD_RIGHT)."\t\t\t".str_pad("LIBELLE",45,' ',STR_PAD_RIGHT)."\t\t\t".str_pad("DATE EFFET",10,' ',STR_PAD_RIGHT)."\n");
            foreach ($ordres as $ordre) {
                fwrite($fp, str_pad($ordre['code'],3,' ',STR_PAD_RIGHT)."\t\t\t".str_pad($ordre['libelle'],45,' ',STR_PAD_RIGHT)."\t\t\t".str_pad(date('d/m/Y',strtotime($ordre['date_debut'])),10,' ',STR_PAD_RIGHT)."\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'civ') {
        ...
        if($nb_profils != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_CIVILITES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 4, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($civilites as $civilite) {
                fwrite($fp, str_pad($civilite['code'], 4, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($civilite['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($civilite['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'sex') {
            ...
            if ($nb_sexes != 0) {
                header('Content-Type: text/csv');
                header('Content-Disposition: attachment; filename="EXPORT_SEXE_' . date('dmYhis', time()) . '.txt"');

                $fp = fopen('php://output', 'wb');
                fwrite($fp, str_pad("CODE", 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
                foreach ($sexes as $sexe) {
                    fwrite($fp, str_pad($sexe['code'], 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($sexe['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($sexe['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
                }
                fclose($fp);
            }
    }
    elseif($data == 'typ_pers') {
            ...
            if ($nb_types_personnes_ecu != 0) {
                header('Content-Type: text/csv');
                header('Content-Disposition: attachment; filename="EXPORT_TYPES_PERSONNES_ECU' . date('dmYhis', time()) . '.txt"');

                $fp = fopen('php://output', 'wb');
                fwrite($fp, str_pad("CODE", 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
                foreach ($types_personnes as $type_personne) {
                    fwrite($fp, str_pad($type_personne['code'], 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($type_personne['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($type_personne['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
                }
                fclose($fp);
            }
    }
    elseif($data == 'tac') {
            ...
            if ($nb_typesaccidents != 0) {
                header('Content-Type: text/csv');
                header('Content-Disposition: attachment; filename="EXPORT_TYPES_ACCIDENTS_' . date('dmYhis', time()) . '.txt"');

                $fp = fopen('php://output', 'wb');
                fwrite($fp, str_pad("CODE", 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
                foreach ($typesaccidents as $typesaccident) {
                    fwrite($fp, str_pad($typesaccident['code'], 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($typesaccident['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($typesaccident['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
                }
                fclose($fp);
            }
    }
    elseif($data == 'sif') {
        ...
        if ($nb_situationfamilles != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_SITUATIONS_FAMILIALES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($situationfamilles as $situationfamille) {
                fwrite($fp, str_pad($situationfamille['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($situationfamille['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($situationfamille['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'sct') {
        ...
        if ($nb_secteursactivites != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_SECTEURS_ACTIVITES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($secteursactivites as $secteursactivite) {
                fwrite($fp, str_pad($secteursactivite['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($secteursactivite['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($secteursactivite['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'prf') {
        ...
        if ($nb_professions != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_PROFESSIONS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($professions as $profession) {
                fwrite($fp, str_pad($profession['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($profession['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($profession['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'qtc') {
        ...
        if ($nb_qualitesciviles != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_QUALITES_CIVILITES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($qualitesciviles as $qualitescivile) {
                fwrite($fp, str_pad($qualitescivile['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($qualitescivile['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($qualitescivile['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'tco') {
        ...
        if ($nb_typescoordonnees != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TYPES_COORDONNEES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 6, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($typescoordonnees as $typescoordonnee) {
                fwrite($fp, str_pad($typescoordonnee['code'], 6, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($typescoordonnee['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($typescoordonnee['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'tpi') {
        ...
        if ($nb_typespiecesidentites != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_TYPES_PIECES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 6, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($typespiecesidentites as $typespiecesidentite) {
                fwrite($fp, str_pad($typespiecesidentite['code'], 6, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($typespiecesidentite['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($typespiecesidentite['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'dev') {
        ...
        if ($nb_devises != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_DEVISES_MONETAIRES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($devises as $devise) {
                fwrite($fp, str_pad($devise['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($devise['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($devise['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'gsa') {
        ...
        if ($nb_groupesanguins != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_GROUPES_SANGUINS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 2, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($groupesanguins as $groupesanguin) {
                fwrite($fp, str_pad($groupesanguin['code'], 2, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($groupesanguin['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($groupesanguin['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'rhs') {
        ...
        if ($nb_groupesanguins != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_RHESUS_SANGUINS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LIBELLE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($groupesanguins as $groupesanguin) {
                fwrite($fp, str_pad($groupesanguin['code'], 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($groupesanguin['libelle'], 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($groupesanguin['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'lge') {
        ...
        if ($nb_pays != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_PAYS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("NOM", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("GENTILE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DEVISE MONNETAIRE", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LATITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LONGITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($pays as $groupesanguin) {
                fwrite($fp, str_pad($groupesanguin['code'], 1, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($groupesanguin['nom'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($groupesanguin['gentile'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($groupesanguin['devise'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($groupesanguin['latitude'], 15, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($groupesanguin['longitude'], 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($groupesanguin['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'reg') {
        ...
        if ($nb_regions != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_REGIONS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("PAYS", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("NOM", 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad("LATITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LONGITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($regions as $region) {
                fwrite($fp, str_pad($region['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($region['nom_pays'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($region['nom'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($region['latitude'], 15, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($region['longitude'], 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($region['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'dep') {
        ...
        if ($nb_departemements != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_DEPARTEMENTS_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("PAYS", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("REGION", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("NOM", 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad("LATITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LONGITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($departemements as $departemement) {
                fwrite($fp, str_pad($departemement['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($departemement['nom_pays'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($departemement['nom_region'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($departemement['nom'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($departemement['latitude'], 15, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($departemement['longitude'], 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($departemement['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
    elseif($data == 'com') {
        require "../_CONFIGS/Classes/LOCALISATIONSGEOGRAPHIQUES.php";
        $COMMUNES = new LOCALISATIONSGEOGRAPHIQUES();
        $communes = $COMMUNES->lister_commune(null);
        $nb_departemements = count($communes);
        if ($nb_departemements != 0) {
            header('Content-Type: text/csv');
            header('Content-Disposition: attachment; filename="EXPORT_COMMUNES_' . date('dmYhis', time()) . '.txt"');

            $fp = fopen('php://output', 'wb');
            fwrite($fp, str_pad("CODE", 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("PAYS", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("REGION", 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad("DEPARTEMENT", 45, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("NOM", 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad("LATITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("LONGITUDE", 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad("DATE EFFET", 10, ' ', STR_PAD_RIGHT) . "\n");
            foreach ($communes as $commune) {
                fwrite($fp, str_pad($commune['code'], 3, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad($commune['nom_pays'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($commune['nom_region'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($commune['nom_departement'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($commune['nom'], 45, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($commune['latitude'], 15, ' ', STR_PAD_RIGHT). "\t\t\t" . str_pad($commune['longitude'], 15, ' ', STR_PAD_RIGHT) . "\t\t\t" . str_pad(date('d/m/Y', strtotime($commune['date_debut'])), 10, ' ', STR_PAD_RIGHT) . "\n");
            }
            fclose($fp);
        }
    }
